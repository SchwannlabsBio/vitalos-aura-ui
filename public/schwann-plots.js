...
var ASM_CONSTS = {
 ...
 181608: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 181691: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 181760: () => { return window.innerWidth; },  
 181790: () => { return window.innerHeight; }
};
